...
buildPath=`pwd`
arch="Release"
target="DLModulesCenter"
projectPath="DLModulesCenter.xcodeproj"
hederFile="Include"
sourceFile="Release"
...
cp ${buildPath}/build/${arch}-iphonesimulator/lib${target}.a ./lib_i386_x86.a
...
cp ${buildPath}/build/${arch}-iphoneos/lib${target}.a ./lib_armv7_arm64.a
